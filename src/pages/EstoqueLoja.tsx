...
import { Plus, Search, Package, Edit, Trash2, TrendingUp, TrendingDown, Wallet, ArrowLeft } from "lucide-react";
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-14 md:h-16 border-b border-border/50 bg-card/50 backdrop-blur-sm flex items-center px-4 md:px-6 sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-2">
              <h2 className="text-base md:text-lg font-semibold text-foreground truncate">Estoque da Loja</h2>
            </div>
          </header>
